...
const NavBar = (props: Props) => {
    ...
    return (
        <div className="bg-clip-padding backdrop-filter sticky top-0 z-50 backdrop-blur-xl bg-opacity-10 max-w-7xl m-auto px-5">
            <div className="flex justify-between p-2 pr-4 items-center text-white rounded-xl">
                ...
                <Fade right cascade>
                    <div className="hidden justify-between gap-14 md:flex">
                        <div className={navItem}>Testimonials</div>
